...
exclude_nonbreeders = 1;
analyze_nonbreeders = 0;
...
genotypez = {'HLA'}%{'APOE' 'c9orf' 'HLA' 'GBA'};
...
%         pubify_figure_axis(14,14);
        ...
        if analyze_nonbreeders == 0
            ...
            set(g_non, 'linestyle','-');
            title(['Average Weekly (NonBreeding) ' genotype ' Weights']);
            ylabel('Weight (g)');
            xlabel('Age (wks)');
%             pubify_figure_axis(14,14);
            
        elseif analyze_nonbreeders == 1
            % Breeders in weeks
            if strcmp(single_geno,'APOE')
...
%             pubify_figure_axis(14,14);
        ...
        if analyze_nonbreeders == 0
            ...
            set(g_non, 'linestyle','-');
            title(['Average Monthly (NonBreeding) ' genotype ' Weights']);
            ylabel('Weight (g)');
            xlabel('Age (months)');
            set(gca,'XLim',[0 24]);
%             pubify_figure_axis(14,14);
...
%         pubify_figure_axis(14,14);
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %% Save figure
        cd('/Users/cristinagarcia/Documents/MATLAB/HLA/')
